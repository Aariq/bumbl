...
```{r}
out <- bumbl(bombus, colonyID = colony, t = week, formula = mass ~ week)
head(out)
```
...
```{r}
out2 <- bumbl(bombus, colonyID = colony, t = week, formula = mass ~ week * cum_floral)
head(out2)
```
...
```{r}
out3 <- bumbl(bombus, colonyID = colony, t = week, formula = mass ~ week, augment = TRUE)
head(out3)
```
