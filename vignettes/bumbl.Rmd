...
The initial growth rate, the rate or decline, and the time to switching to reproduction may vary in response to envrionmental conditions [@croneBumbleBeeColony2016].
...
A range of values for $\tau$ are tested and the value that maximizes likelihood is used for the final model.

$$
ln(W_t) = \beta_0 + \beta_1t + \beta_2post
$$
