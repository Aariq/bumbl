...
```{r include=FALSE}
cap <- "Example output from plotting a `bumbl()` data frame. Each panel represents a different colony in the dataset."
```
...
```{r plot, echo=FALSE, fig.cap=cap}
p + labs(y = TeX("$\\Delta$mass(g)"))
```

<!--# something about the dataset included? -->
